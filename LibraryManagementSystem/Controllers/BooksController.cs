...
namespace LibraryManagementSystem.Controllers
{
    public class BooksController : Controller
    {
        ...
        public BooksController(Library_Management_SystemContext context, IAccountRepo accountsRepo)
        {
            _context = context;
        ...
        {
            var library_Management_SystemContext = _context.Books.Include(a => a.Author).Include(p => p.Publisher);
        ...
        public async Task<IActionResult> ViewBooks(string searchstring)
        {
            ...
            {
                library_Management_SystemContext = _context.Books.Where(b =>
                                 b.Author.AuthorName.Contains(searchstring) ||
                                 b.BookCategory.Contains(searchstring) ||
        ...
        public async Task<IActionResult> Create([Bind("BookId,BookTitle,NumberOfCopies,AuthorId,PublisherId,BookCategory,BookImageUrl,IssuedBooks,IsAvailable")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,BookTitle,NumberOfCopies,AuthorId,PublisherId,BookCategory,BookImageUrl,IssuedBooks,IsAvailable")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
